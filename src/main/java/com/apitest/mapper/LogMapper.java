...
public interface LogMapper {
    ...
    @Insert("insert into logs(request_time, response_body, response_header, code, api_id, case_name) values(#{requestTime}, #{responseBody}, #{responseHeader}, #{code}, #{apiId}, #{caseName})")
    void save(Logs logs);
}
